  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Shipping / Software Delivery Policy</h1>

        <p className="text-gray-600 leading-relaxed mb-6">
          We provide restaurant management software through electronic/online delivery. No physical products are shipped.
        </p>

        <p className="text-gray-600 leading-relaxed mb-6">
          After successful payment and account activation, the customer will receive access to the software electronically.
        </p>

        <p className="text-gray-600 leading-relaxed">
          Software access is normally activated within 5 business days after successful payment and completion of the required customer onboarding information.
        </p>
      </div>
